...
// per-window language detection and word-level timestamps; heavier but caption-grade timing.
// NOTE: WhisperKit's result types share names with ours (TranscriptionResult/Segment);
// this file avoids spelling them and lets inference bind them.
import Foundation
import WhisperKit
