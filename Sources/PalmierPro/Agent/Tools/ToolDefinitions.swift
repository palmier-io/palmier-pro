        ...
        AgentTool(
            ...
            inputSchema: objectSchema(
                properties: [
                    ...
                    "isBold": ["type": "boolean", "description": "Text clips only. Toggles the bold trait when the selected font can resolve it."],
                    "isItalic": ["type": "boolean", "description": "Text clips only. Toggles the italic trait when the selected font can resolve it."],
                    ...
                    "entries": [
                        ...
                        "items": [
                            ...
                            "properties": [
                                ...
                                "isBold": ["type": "boolean", "description": "Toggle the bold trait when the selected font can resolve it. Default true."],
                                "isItalic": ["type": "boolean", "description": "Toggle the italic trait when the selected font can resolve it. Default false."],
        ...
        AgentTool(
            ...
            inputSchema: objectSchema(
                properties: [
                    ...
                    "isBold": ["type": "boolean", "description": "Optional. Toggle the bold trait when the selected font can resolve it (default true)."],
                    "isItalic": ["type": "boolean", "description": "Optional. Toggle the italic trait when the selected font can resolve it (default false)."],
