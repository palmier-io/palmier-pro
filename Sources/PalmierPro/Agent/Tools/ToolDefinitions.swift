        ...
        AgentTool(
            ...
            inputSchema: objectSchema(
                properties: [
                    ...
                    "language": ["type": "string", "description": "Video/audio. Optional BCP-47 language of the speech (e.g. 'fr', 'ja', 'en-GB'). Overrides the project's transcriptionLanguage for this call; if neither is set, defaults to the system language. Set this when the audio is in another language, or transcription will be garbage."],
                ],
                required: ["mediaRef"]
            )
        ),
        ...
        AgentTool(
            ...
            inputSchema: objectSchema(
                properties: [
                    ...
                    "language": ["type": "string", "description": "Optional BCP-47 language of the speech (e.g. 'es', 'ja', 'en-GB'). Overrides the project's transcriptionLanguage for this call; if neither is set, defaults to the system language. Set this when the footage is in another language, or transcription will be garbage."],
