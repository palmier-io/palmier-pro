                    ...
                    "entries": [
                        ...
                        "items": [
                            ...
                            "properties": mergedProperties([
                                ...
                                "fillMode": ["type": "string", "enum": ["color", "footage"], "description": "color = solid typography (default). footage = reveal layers below only inside the letter shapes."],
                            ]),
        ...
        AgentTool(
            ...
            inputSchema: objectSchema(
                properties: mergedProperties([
                    ...
                    "animation": ["type": "string", "enum": TextAnimation.Preset.agentValues, "description": "Animation preset; off clears."],
                    "highlightColor": ["type": "string", "description": "Active-word hex."],
                    "fillMode": ["type": "string", "enum": ["color", "footage"], "description": "color = solid typography. footage = reveal layers below only inside the letter shapes."],
                ]),
                required: []
            )
        ),
