...
Tool count: 42 in-app agent tools, 41 MCP-exposed tools.
...
23. `export_project` — In-app agent and MCP
24. `generate_video` — In-app agent and MCP
25. `generate_image` — In-app agent and MCP
26. `generate_audio` — In-app agent and MCP
27. `upscale_media` — In-app agent and MCP
28. `import_media` — In-app agent and MCP
29. `list_folders` — In-app agent and MCP
30. `create_folder` — In-app agent and MCP
31. `move_to_folder` — In-app agent and MCP
32. `rename_media` — In-app agent and MCP
33. `rename_folder` — In-app agent and MCP
34. `delete_media` — In-app agent and MCP
35. `delete_folder` — In-app agent and MCP
36. `list_models` — In-app agent and MCP
37. `apply_effect` — In-app agent and MCP
38. `apply_color` — In-app agent and MCP
39. `inspect_color` — In-app agent and MCP
40. `set_project_settings` — In-app agent and MCP
41. `send_feedback` — In-app agent and MCP
42. `read_skill` — In-app agent only
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:57`
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:67`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:72`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:89`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:101`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:112`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:125`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:151`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:177`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:192`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:207`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:230`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:274`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:311`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:331`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:358`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:380`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:400`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:414`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:419`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:450`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:474`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:493`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:506`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:529`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:546`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:567`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:579`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:600`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:605`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:627`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:657`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:679`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:701`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:738`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:771`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:836`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:848`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:861`
- Availability: In-app agent and MCP
...
- Source line: `Sources/PalmierPro/Agent/Tools/ToolDefinitions.swift:891`
